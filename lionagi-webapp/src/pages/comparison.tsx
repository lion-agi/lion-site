      ...
      <main className="pt-16">
        ...
        <section className="py-24 md:py-32 bg-gradient-to-b from-[#0f0f0f] to-[#111111]">
          <div className="container mx-auto px-4 md:px-6 text-center space-y-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#D4AF37] to-[#F1C40F]">
              How We Compare
            </h1>
        ...
        <section className="py-24 md:py-32 bg-[#0f0f0f]">
          <div className="container mx-auto px-4 md:px-6 space-y-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-[#D4AF37] to-[#F1C40F]">
